...
Reads the database URL from application Settings and uses SQLAlchemy metadata
from our models for autogenerate support.
"""
...
from vacation_tracker.db import models as models  # noqa: F401
